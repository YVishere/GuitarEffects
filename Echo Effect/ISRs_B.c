...
#define BUFFER_LENGTH   1584 // buffer length in samples   --> Corresponds to a delay of 0.033 sec/33 ms which is the average delay of an echo in a room and above the minimum delay to hear an echo
